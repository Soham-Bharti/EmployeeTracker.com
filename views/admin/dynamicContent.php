...
if (isset($_POST['newDate'])) {
    ...
    <div class='card-body' id='attendanceDiv'>
        <div class='d-flex justify-content-around align-items-center p-0 m-0'>
            <p class='card-title fs-6'>Attendance on <br/>(<span id='todayAttendanceDate'>";
    echo $date;
    echo "</span>): </p>";
    ...
    echo "<p class='fw-bold display-6'><span class='";
    echo $totalCheckedInUsersTodayCount >= 0.75 * $totalEmployeesCount ? 'text-success' : 'text-danger';
    echo "'>";
    echo $totalCheckedInUsersTodayCount;
    echo "</span>/";
    echo $totalEmployeesCount;
    echo "</p>
        </div>";
    $absentEmployees = [];
...
<div class='card' style='width: 17rem;'>
    ...
    <div class='card-body'>
        <div class='d-flex justify-content-around align-items-center p-0 m-0'>
            <p class='card-title fs-6'>Work Time < 8.45Hrs. on <br/>(<span id='yesterdayWorkingDate'>";
    ...
    echo "<p class='fw-bold display-6'>";
    echo sizeof($showEmployeesWithLessWorkingHoursYesterdayArray);
    echo "</p>
        </div>
    ...
    foreach ($showEmployeesWithLessWorkingHoursYesterdayArray as $name => $total_seconds) {
        ...
        echo "<p>";
        echo explode(' ', $name)[0] . ' - '.$formatted_time;
        echo "</p>
                            <hr>";
    }
...
<div class='card' style='width: 17rem;'>
    ...
    <div class='card-body'>
        <div class='d-flex justify-content-around align-items-center p-0 m-0'>
            <p class='card-title fs-6'>Missed PMS on <br/>(<span id='yesterdayPMSDate'>";
    echo date('Y-m-d', strtotime('-1 day', strtotime($date)));
    echo "</span>): </p>";
    ...
    echo "<p class='fw-bold display-6'>";
    echo sizeof($employeesWithNoPMSYesterdayArray);
    echo "</p>
        </div>
